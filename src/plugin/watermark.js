 ...
 * @LastEditors:
 * @LastEditTime: 2022-09-30 01:01:33
 * @Description:
 */
...
export default function watermark(settings) {
  ...
  for (var i = 0; i < defaultSettings.watermark_rows; i++) {
    ...
    for (var j = 0; j < defaultSettings.watermark_cols; j++) {
      ...
      txtSpan.style.setProperty('font-size', defaultSettings.watermark_fontsize, 'important');
  ...
  maskWrap.style.cssText = 'position: absolute; top: 0;right: 0; bottom: 0;left: 0; z-index: 9999; pointer-events: none;overflow: hidden';
