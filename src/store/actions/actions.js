...
const that = createApp.prototype
...
export default {
      ...
      let state = {
        appConfig: {
          ...
          site: {
            ...
            logoURL:
              that.LODASH.get(res.data, 'site.brandUrl') ||
              require('@/assets/img/logo/favicon.png'),
            ...
            openLabelClassification:
              that.LODASH.get(res.data, 'site.openLabelClassification') || false,
            serviceQRCodeUrl:
              that.LODASH.get(res.data, 'site.serviceQRCodeUrl') ||
              require('@/assets/img/logo/weixin.png')
          }
        },
  ...
  snapshoot(context, payload) {
    ...
    console.log('this.storage', this)
    storage.setItem('localUser', {
      id: user.id,
      name: user.name,
      code: user.code,
      headImg: user.headImg,
